    ...
    <div class="d-flex justify-content-between align-items-center pt-3">
        <div class="logo">
            <a href="{{ url('/') }}">
                ...
                $route == 'dashboard.index' || $route == 'dashboard.show' || $route == 'dashboard.edit' || $route ==
                'followers' || $route == 'followings' || $route == 'locations')
                @if ($route == 'followers' || $route == 'followings' || $route == 'locations')
