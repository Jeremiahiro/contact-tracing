<div class="modal fade right" id="userFollowing" tabindex="-1" role="dialog" aria-labelledby="sideNavlLabel">
                ...
                <div class="activityView">
                    <div class="activityTab">
                        <ul class="mb-0 mt-3 f-12 nav">
                            <li class="active"><a data-toggle="tab" href="#FSmutual"
                                    class="text-primary active">Mutual</a></li>
                            <span class="mx-1">|</span>
                            <li><a data-toggle="tab" href="#FSneutral" class="text-primary">Neutral</a></li>
                        </ul>
                    </div>
                    <div class="py-3 tab-content">
                        <div class="tab-pane active" id="FSmutual">
                        ...
                        <div class="tab-pane fade" id="FSneutral">
