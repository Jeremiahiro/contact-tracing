            ...
            a.find(".rescalendar_day_cells").html(i),
                function (t) {
                    t.find("td.day_cell").on("click", function (a) {
                        var date_data = a.currentTarget.attributes["data-cellDate"].value;
                        t.find("input.refDate").val(date_data), o(t, moment(e, l.format))
                        // console.log(e);
                        $('#date_sort').val(date_data);

                        var newDate = $('#date_sort').val();
